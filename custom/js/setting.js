$(document).ready(function() {
    ...
    $("#changeUsernameForm").unbind('submit').bind('submit', function() {
        ...
        if (username == "") {
            $("#username").after('<p class="text-danger">Nombre de usuario es Obligatorio</p>');
    ...
    $("#changePasswordForm").unbind('submit').bind('submit', function() {
        ...
        if (currentPassword == "" || newPassword == "" || conformPassword == "") {
            ...
            if (newPassword == "") {
                $("#npassword").after('<p class="text-danger">El campo Nueva Clave es Obligatorio</p>');
            ...
            if (conformPassword == "") {
                $("#cpassword").after('<p class="text-danger">El campo Confirmar Clave es Obligatorio</p>');
